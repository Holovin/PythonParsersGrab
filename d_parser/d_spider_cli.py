...
from d_parser.helpers.url_lib import get_host_from_url
...
class DSpider(Spider):
    ...
    def __init__(self, thread_number, logger_name, writer, try_limit=0):
        ...
        self.domain = get_host_from_url(Config.get_seq('SITE_URL')[0])
    ...
    def task_initial(self, grab, task):
        ...
        try:
            ...
            err = '[items] Url {} parse failed (e: {}), debug: {}'.format(task.url, e, get_body(grab))
            Output.print(err)
